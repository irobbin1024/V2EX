...
+(NSDictionary *)group:(NSArray *)datas key:(NSString *)key{
    ...
    NSMutableArray *charSortArray = [[NSMutableArray alloc] initWithArray:[charArray sortedArrayUsingSelector:@selector(compare:)]];
    if ([charSortArray containsObject:@"#"]) {
        [charSortArray removeObject:@"#"];
        [charSortArray addObject:@"#"];
    }
